...
type Txs struct {
	...
	Valprio uint64   `protobuf:"varint,2,opt,name=valprio,proto3" json:"valprio,omitempty"`
}
...
var fileDescriptor_2af51926fdbcbc05 = []byte{
	...
	,
}
...
func (m *Txs) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Valprio != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.Valprio))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Txs) > 0 {
...
func (m *Txs) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Valprio", wireType)
			}
			m.Valprio = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
